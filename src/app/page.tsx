    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gray-50 py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative order-first md:order-last">
              <Image
                src="https://ext.same-assets.com/1936736741/3275464490.webp"
        ...
        <div className="absolute bottom-4 left-4 flex items-center">
          <Image src="https://ext.same-assets.com/1936736741/411388117.svg" alt="ES" width={20} height={15} />
      ...
      <div className="bg-white py-4">
        <div className="container mx-auto px-4">
          <Image
            src="https://ext.same-assets.com/1936736741/1919831204.jpeg"
            alt="Kit Digital"
            width={1024}
            height={62}
